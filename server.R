...
shinyServer(function(input,output,session) {
  ...
  output$plot_summary <- renderPlot({
    ...
    Text1 = textGrob("Mean",gp=gpar(col="gray50",fontsize = 10,fontface=1))
    Text2 = textGrob("Dispersion",gp=gpar(col="gray50",fontsize = 10,fontface=1))
    ...
    p1 <- p1 + annotation_custom(grob = Text1, xmin = 0, xmax = 10, ymin = 0, ymax = 2.6)
    p1 <- p1 + annotation_custom(grob = Text2, xmin = 0, xmax = 17, ymin = 0, ymax = -2.6)
    p3 <- p3 + annotation_custom(grob = Text1, xmin = 0, xmax = 10, ymin = 0, ymax = 2.6)
    p3 <- p3 + annotation_custom(grob = Text2, xmin = 0, xmax = 17, ymin = 0, ymax = -2.6)
